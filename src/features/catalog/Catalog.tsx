...
export default function Catalog() {
  ...
  // Create a new useEffect to dispatch filters.
  // This is done to avoid app to re-load products twice (when using both if statements inside the same use effect.). 
  useEffect(() => {
